...
Route::prefix('v3')->group(function () {
    ...
    Route::get('user', function () {
        return 'v3 api user;router';
    });

    Route::get('usera', function () {
        return 'v3 api usera;router';
    });
...
Route::prefix('v4')->middleware('auth:apitoken')->group(function () {
    ...
    Route::get('user', function () {
        return 'v4 api user; middleware; router';
    });

    Route::get('usera', function () {
        return 'v4 api usera;middleware;router';
    });
